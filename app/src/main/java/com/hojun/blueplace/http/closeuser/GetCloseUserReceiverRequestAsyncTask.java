...
public class GetCloseUserReceiverRequestAsyncTask extends AsyncTask<Void, Integer, Void> {
    ...
    public GetCloseUserReceiverRequestAsyncTask(LocalDatabase localDatabase, HttpProgressInterface httpProgressInterface) {
        super();
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            // 로그
            URL url = new URL("http://" + MainActivity.serverAddr + "/api/closeusers/request?flag=receiver");
