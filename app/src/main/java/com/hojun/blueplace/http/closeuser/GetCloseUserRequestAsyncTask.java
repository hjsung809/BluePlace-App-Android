...
public class GetCloseUserRequestAsyncTask extends AsyncTask<Void, Integer, Void> {
    ...
    public GetCloseUserRequestAsyncTask(LocalDatabase localDatabase, HttpProgressInterface httpProgressInterface) {
        super();
